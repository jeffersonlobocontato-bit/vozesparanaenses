...
insert into public.sobre_config (
  ...
  'Trabalhamos com o Método **DEL — Decomposição de Estrutura de Linguagem**. A partir da coleta de fontes públicas (portais oficiais, RSS, veículos regionais), aplicamos reescrita editorial com verificação factual pelo padrão jornalístico **5W1H** (o quê, quem, quando, onde, por quê e como). Nenhuma matéria vai ao ar sem passar por editoria humana.',
