...
type Variant = "banner" | "inline" | "button";
...
export function WhatsAppCTA({
  ...
  if (variant === "button") {
    return (
      <a
        ...
        className={
          "inline-flex w-fit items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#1ebe57] " +
          className
        }
      >
        <svg
        ...
        <span className="hidden sm:inline">Comunidade no WhatsApp</span>
  ...
  if (variant === "inline") {
    return (
      <a
        ...
        aria-label="Entrar na Comunidade do WhatsApp da Vozes Paranaenses"
        className={
          "flex w-full items-center justify-between gap-2 rounded-md border border-[#25D366]/30 bg-[#25D366]/5 px-3 py-2 text-sm text-slate-700 transition-colors hover:bg-[#25D366]/10 " +
          className
        }
      >
        <span className="flex min-w-0 items-center gap-2">
          ...
          <span className="truncate">Receba as notícias do Paraná no WhatsApp</span>
        </span>
        <span className="shrink-0 text-xs font-semibold text-[#128C4B]">Entrar →</span>
      </a>
    );
  }
  ...
  return (
    ...
    >
      ...
      <span className="shrink-0 rounded-sm bg-white px-3 py-1.5 text-[11px] font-black uppercase tracking-wider text-[#128C4B]">
        Entrar
      </span>
    </a>
  );
