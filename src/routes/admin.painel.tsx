...
{pipelineLog.join("\n")}
      ...
      <Section title="Gestão" subtitle="Atalhos das áreas de trabalho">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          <Shortcut to="/admin" icon={Newspaper} tone="blue" title="Fila editorial" desc="Revisar, editar e publicar matérias." />
          <Shortcut to="/admin/clusters" icon={Sparkles} tone="amber" title="Diagnóstico do pipeline" desc="Clusters, score de interesse e o que foi descartado por cota." />
