    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <article className="mx-auto max-w-4xl px-4 pb-16 pt-8 md:pt-12">
        ...
        <div className="mx-auto mt-8 flex max-w-3xl justify-center">
          <AdSlot size="728x90" regiao={region} cidade={cidadeAtualSlug} editoria={categoriaSlug} />
        </div>
                ...
                <div key={`p-${i}`}>
                  ...
                  {i === adMidIndex && (
                    <div className="my-8 flex justify-center">
                      <AdSlot size="300x250" regiao={region} cidade={cidadeAtualSlug} editoria={categoriaSlug} />
                    </div>
                  )}
        ...
        <div className="mx-auto mt-10 flex max-w-3xl justify-center">
          <AdSlot size="970x90" regiao={region} cidade={cidadeAtualSlug} editoria={categoriaSlug} />
        </div>
